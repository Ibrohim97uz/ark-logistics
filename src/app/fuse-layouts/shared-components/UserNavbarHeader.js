...
function UserNavbarHeader(props) {
	...
	return (
		...
		>
			...
			<Typography className="email text-16 opacity-50 whitespace-nowrap font-medium" color="inherit">
				{user.role}
			</Typography>
			...
			{/* <div className="flex items-center justify-center absolute bottom-0 -mb-44">
				<Avatar
					...
					alt="user photo"
					src={user.image && user.photoURL !== '' ? user.image : 'assets/images/avatars/profile.jpg'}
				/>
			</div> */}
		</AppBar>
	);
